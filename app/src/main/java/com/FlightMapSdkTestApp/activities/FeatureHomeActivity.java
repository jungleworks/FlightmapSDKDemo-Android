...
import com.FlightMapSdkTestApp.FlightMapApplication;
import com.FlightMapSdkTestApp.R;
import com.FlightMapSdkTestApp.sectionheader.Feature;
import com.FlightMapSdkTestApp.sectionheader.FeatureAdapter;
import com.FlightMapSdkTestApp.sectionheader.FeatureSectionAdapter;
import com.FlightMapSdkTestApp.utils.ItemClickSupport;
...
public class FeatureHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Method called to set access token for FlightMap
        ((FlightMapApplication)getApplicationContext()).setaccesstoken();
        ...
        protected List<Feature> doInBackground(PackageInfo... params) {
            ...
            for (ActivityInfo info : app.activities) {
                if (info.labelRes != 0 && info.name.startsWith(packageName)
                        && !info.name.equals(FeatureHomeActivity.class.getName())) {
